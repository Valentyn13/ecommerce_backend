...
const isLaptopExist_middleware_1 = __importDefault(require("../../middlewares/isLaptopExist.middleware"));
...
laptopRouter.get('/byId', isLaptopExist_middleware_1.default, (0, response_middleware_1.default)(laptop_controller_1.default.getLaptopById.bind(laptop_controller_1.default)));
