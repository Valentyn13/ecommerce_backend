...
export const userValidate = async (req: IUserRequest, res: Response, next: NextFunction) => {
  try {
...
export const isUserExist = async (req: IUserRequest, res: Response, next: NextFunction) => {
